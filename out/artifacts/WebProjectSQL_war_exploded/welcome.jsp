...
<table class="table">
    ...
    <tr>
        ...
        <td><button type="button" class="btn btn-warning" formaction="/deleteServlet" formmethod="post" onclick="document.location.href='/deleteServlet?id='+<%=rs.getString(1)%>"  >DELETE</button></td>
    </tr>
